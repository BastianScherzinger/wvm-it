...
urlpatterns = [
    ...
    # erwartet, landet im Nichts. Ein dauerhafter 301 statt einer eigenen Seite:
    # Es gibt keinen zweiten Bestand, nur einen Tippfehler, den wir auffangen.
    #
    # Die Umleitung steht in views.de_praefix_umleiten und **nicht** als Lambda
    # hier: Die erste Fassung baute das Ziel als `"/" + rest` zusammen und war
    # damit ein offener Weiterleiter (`/de//fremde-seite.example/`). Begründung
    # und die zwei Schranken stehen im Docstring der Ansicht.
