...
SEITEN = {
    ...
    "it-betreuung-groessere-betriebe": {
        ...
        "preis_h": "Cât costă",
        "preis_t": "Asistența curentă costă de la 29 € pe stație și lună, un server administrat de la 89 € pe lună, copia de siguranță monitorizată de la 49 € pe lună. Pentru o firmă tipică mai mare, cu 30 de stații și 2 servere plus copie de siguranță, rezultă circa 1.097 € pe lună (30 × 29 € + 2 × 89 € + 49 €). Lucrările punctuale se facturează cu 95 € pe oră, la fața locului cu 120 € pe oră plus deplasare. Prețuri orientative, net, fără TVA. Fără supliment pentru sedii suplimentare în Austria și Germania, deoarece activitatea curentă prin mentenanță la distanță este oricum independentă de locație.",
        "faq": [
            ...
            {"q": "Avem mai multe sedii — funcționează prin mentenanță la distanță?",
             "a": "Pentru activitatea curentă da: accesul securizat nu diferențiază între unul și cinci sedii. Pentru montaj, cablare și echipamente venim la fața locului; pentru sedii din Germania planificăm cu mai mult timp și calculăm deplasarea în avans."},
