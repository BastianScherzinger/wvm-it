...
SEITEN = {
    ...
    "edv-it-betreuung": {
        ...
        "faq": [
            ...
            {"q": "Ce înseamnă la dumneavoastră firmă mică?",
             "a": "Ca reper general, tot ce este până la aproximativ 20 de posturi de lucru la unul sau două sedii — dimensiunea tipică a unui PFA, unei firme meșteșugărești, unui cabinet sau unui birou. Peste această limită asistența devine de obicei mai formală (standarde fixe, documentație mai largă, mai multe persoane de contact); pentru aceasta avem o <a href=\"/ro/leistungen/it-betreuung-groessere-betriebe/\">pagină separată pentru firmele mai mari</a>. Linia nu este strictă: o firmă cu 25 de stații și o singură aplicație se potrivește adesea mai bine aici decât una cu 15 stații și trei sedii."},
            {"q": "Cât costă concret administrarea IT pentru o firmă mică tipică?",
             "a": "Exemplu de calcul pentru o firmă cu cinci stații, un server și copie de siguranță monitorizată: 5 × 29 € + 89 € + 49 € = 283 € pe lună, net fără TVA. Pentru zece stații cu server și copie de siguranță, 428 € pe lună (10 × 29 € + 89 € + 49 €). Dacă folosiți Microsoft 365, prețul licenței de la Microsoft se adaugă — îl plătiți direct la Microsoft, noi doar configurăm."},
            {"q": "Avem doar două-trei calculatoare — este necesară deja administrarea?",
    ...
    "ki-automatisierung": {
        ...
        "intro": "Automatizarea nu merită acolo unde arată impresionant, ci acolo unde aceeași mișcare se repetă de douăzeci de ori pe zi: același răspuns la aceeași întrebare, aceeași programare, aceeași confirmare. De aceea nu pornim niciodată de la tehnică, ci de la întrebarea care cinci minute se repetă cel mai des. Restul este jucărie cu factură. Automatizarea cu inteligență artificială nu este un produs de sine stătător, ci un flux: un program preia o sarcină care se repetă — aceeași întrebare, o cerere de programare, o confirmare —, o rezolvă sau o transmite și așază rezultatul în sistemul în care se lucrează oricum. Ce apare rar sau trebuie decis de fiecare dată din nou rămâne în mod deliberat la un om.",
    ...
    "it-betreuung-groessere-betriebe": {
        ...
        "probleme": [
            "Documentația trăiește în patru capete și în niciun document.",
            "Nu există o imagine actuală a tot ce rulează — servere, aplicații, conturi, contracte.",
            "Sediile au fost adăugate în timp, fiecare într-un fel diferit.",
            "Nimic nu se oprește când cineva lipsește, dar nimeni nu îndrăznește să schimbe ceva.",
            "Există un rol IT intern, dar fără timp și fără înlocuitor.",
        ],
        "leistung_h": "Ce preluăm pentru firme mai mari",
        "leistungen": [
            "Evaluare și documentare a tuturor serverelor, stațiilor, aplicațiilor, conturilor și contractelor",
            "Persoană de contact fixă cu înlocuitor; un al doilea tehnician cunoaște rețeaua dumneavoastră",
            ...
            "Co-asistență alături de un IT intern existent: a doua opinie, acoperire, cazuri excepționale, teme fără timp",
            "Ședință operativă trimestrială, în scris: ce a mers, ce a ieșit în evidență, ce urmează",
        ],
        "ablauf_h": "Cum preluăm firmele mai mari",
        "ablauf": [
            {"h": "Evaluare cu vizite la sedii", "t": "Parcurgem sediile și citim serverele, rețeaua și aplicațiile. Rezultatul este o imagine scrisă a ceea ce aveți și o listă cu locurile pe care le-am atinge mai întâi."},
            {"h": "Preluare pe etape", "t": "Nu se preia totul deodată, ci după priorități: mai întâi copia de siguranță, apoi serverele și conturile, apoi stațiile. Activitatea curentă nu simte nimic."},
            {"h": "Operare cu documentație", "t": "De atunci persoana de contact se anunță când ceva iese în evidență, în loc să vă lase pe dumneavoastră să o faceți. Fiecare modificare este consemnată. Trimestrial discutăm ce urmează."},
        ],
        "preis_h": "Cât costă",
        ...
        "faq": [
            ...
            {"q": "Avem mai multe sedii — funcționează prin mentenanță la distanță?",
             "a": "Pentru activitatea curentă da: accesul securizat nu diferențiază între unul și cinci sedii. Pentru montaj, cablare și echipamente venim la fața locului în zona din jurul localității Lenzing (aproximativ o oră cu mașina); pentru sedii mai îndepărtate discutăm în prealabil dacă venim noi sau colaborăm cu un partener local — deplasarea este întotdeauna comunicată în scris în ofertă."},
            {"q": "Ce facem dacă avem nevoie de o disponibilitate anume?",
             "a": "Timpii de răspuns în afara programului și timpii ficși de restaurare fac obiectul unei convenții separate, pentru că măresc atât efortul, cât și costul. Vă spunem cinstit ce promisiune se poate ține cu ce efort, în loc să scriem un angajament 24/7 într-un contract de asistență care ajunge să atârne de o singură persoană."},
            {"q": "Cum ieșim din colaborare dacă până la urmă nu se potrivește?",
