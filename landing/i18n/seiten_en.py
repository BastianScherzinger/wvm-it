...
SEITEN = {
    ...
    "edv-it-betreuung": {
        ...
        "faq": [
            ...
            {"q": "What counts as a small business to you?",
             "a": "As a rough frame, anything up to around 20 workstations at one or two sites — the typical size of a sole trader, a trades business, a practice or a firm. Above that support usually becomes more formal (fixed standards, broader documentation, several contacts); for that we have a <a href=\"/en/leistungen/it-betreuung-groessere-betriebe/\">separate page for larger businesses</a>. The line is not sharp: a 25-seat business with a single application often fits this page better than a 15-seat business with three sites."},
            {"q": "What does IT support for a typical small business cost in practice?",
             "a": "Example for a business with five workstations, one server and monitored backup: 5 × €29 + €89 + €49 = €283 per month, net plus VAT. For ten workstations with server and backup it is €428 per month (10 × €29 + €89 + €49). If you use Microsoft 365, the licence price from Microsoft comes on top — you pay that directly to Microsoft, we only do the setup."},
            {"q": "We only have two or three computers — do we already need support?",
    ...
    "ki-automatisierung": {
        ...
        "intro": "Automation pays off not where it looks impressive but where the same movement happens twenty times a day: answering the same question, entering the same appointment, writing the same confirmation. So we never start with the technology but with the question of which five minutes repeat most often. Everything else is a toy with an invoice attached. AI automation is not a product in its own right but a sequence: a program takes in a recurring task — the same question again, an appointment request, a confirmation — answers or forwards it, and files the result in the system people already work in. Whatever occurs only rarely, or has to be decided afresh each time, deliberately stays with a person.",
    ...
    "it-betreuung-groessere-betriebe": {
        ...
        "kurz": "WVM-IT also looks after larger businesses of roughly 20 to 200 workstations: audit and living documentation, a named contact with backup, monitoring of servers and network, multiple sites via secure remote maintenance. Day-to-day support starts at €29 per workstation and month, a managed server at €89 per month. For a business with 30 workstations and 2 servers this gives a frame of about €1,097 per month (30 × €29 + 2 × €89 + €49 backup). Where an internal IT function exists, we work alongside it — as a second tier for topics that fall between the daily cracks.",
        ...
        "probleme": [
            "The documentation lives in four heads and in no document.",
            "There is no current picture of everything that runs — servers, applications, accounts, contracts.",
            "Sites were added over time, each in its own way.",
            "Nothing stops when someone is out, but nobody dares to change anything.",
            "An internal IT role exists, but has neither time nor a stand-in.",
        ],
        "leistung_h": "What we take on for larger businesses",
        "leistungen": [
            "Audit and documentation of all servers, workstations, applications, accounts and contracts",
            "Named contact with a backup engineer who also knows your network",
            ...
            "Co-support alongside an existing internal IT: second opinion, cover, exceptions, topics without time",
            "Quarterly operating review, in writing: what ran, what stood out, what is next",
        ],
        "ablauf_h": "How we take over larger businesses",
        "ablauf": [
            {"h": "Audit with site walks", "t": "We walk the sites and read out servers, network and applications. The output is a written picture of what you have and a shortlist of the places we would tackle first."},
            {"h": "Handover in stages", "t": "Nothing is taken over in one go: first the backup, then servers and accounts, then the workstations. Your day-to-day work does not notice it."},
            {"h": "Running with documentation", "t": "From then on the contact reaches out when something stands out, instead of waiting for you. Every change is recorded. Once a quarter we talk through what is coming."},
        ],
        "preis_h": "What it costs",
        ...
        "faq": [
            ...
            {"q": "We have multiple sites — does remote maintenance work?",
             "a": "For day-to-day work yes: secure access does not care about one or five sites. For build-out, cabling and hardware we come on site within our catchment around Lenzing (about one hour by car); for sites further away we discuss beforehand whether we travel ourselves or coordinate with a local partner — the travel is always stated in writing in the quote."},
            {"q": "What if we need a specific availability?",
             "a": "Response times outside office hours and fixed recovery times are the subject of a separate agreement, because they raise both effort and cost. We say honestly which promise fits which effort, rather than writing a 24/7 commitment into a support contract that ends up hanging on one person."},
            {"q": "How do we exit if it does not fit after all?",
