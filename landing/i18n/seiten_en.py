...
SEITEN = {
    ...
    "it-betreuung-groessere-betriebe": {
        ...
        "preis_h": "What it costs",
        "preis_t": "Day-to-day support costs from €29 per workstation and month, a managed server from €89 per month, monitored backup from €49 per month. For a typical larger business with 30 workstations and 2 servers plus backup that comes to about €1,097 per month (30 × €29 + 2 × €89 + €49). Ad-hoc work is billed at €95 per hour, on-site work at €120 per hour plus travel. Guide prices, net plus VAT. No surcharge for additional sites within Austria and Germany because remote support is location-independent anyway.",
        "faq": [
            ...
            {"q": "We have multiple sites — does remote maintenance work?",
             "a": "For day-to-day work yes: secure access does not care about one or five sites. For build-out, cabling and hardware we come on site; for sites in Germany we plan with more lead time and calculate travel in advance."},
