...
SEITEN = {
    ...
    "it-betreuung-groessere-betriebe": {
        ...
        "preis_h": "Was das kostet",
        "preis_t": "Die laufende Betreuung kostet ab 29 € je Arbeitsplatz und Monat, ein betreuter Server ab 89 € im Monat, die überwachte Datensicherung ab 49 € im Monat. Für einen typischen größeren Betrieb mit 30 Arbeitsplätzen und 2 Servern samt Datensicherung ergibt das rund 1.097 € im Monat (30 × 29 € + 2 × 89 € + 49 €). Punktuelle Arbeiten rechnen wir mit 95 € je Stunde ab, Einsätze vor Ort mit 120 € je Stunde zuzüglich Anfahrt. Richtpreise, netto zzgl. USt. Kein Preisaufschlag für zusätzliche Standorte innerhalb Österreichs und Deutschlands, weil der laufende Betrieb per Fernwartung ohnehin ortsunabhängig ist.",
        "faq": [
            ...
            {"q": "Wir haben mehrere Standorte — geht das per Fernwartung?",
             "a": "Für den Betrieb ja: Der gesicherte Zugriff kennt keinen Unterschied zwischen einem und fünf Standorten. Für Aufbau, Verkabelung und Hardware kommen wir vor Ort; bei Standorten in Deutschland planen wir das mit mehr Vorlauf und rechnen die Anfahrt vorher aus."},
