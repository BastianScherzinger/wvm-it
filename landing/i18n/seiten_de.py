...
SEITEN = {
    ...
    "edv-it-betreuung": {
        ...
        "leistung_h": "Was wir für kleine Betriebe übernehmen",
        "leistungen": [
        ...
        "faq": [
            ...
            {"q": "Was zählt bei Ihnen als Kleinbetrieb?",
             "a": "Als grober Rahmen alles bis etwa 20 Arbeitsplätzen an einem oder zwei Standorten — die typische EPU-, Handwerks-, Praxis- oder Kanzleigröße. Darüber wird die Betreuung meist förmlicher (feste Standards, breitere Dokumentation, mehrere Ansprechpartner); dafür haben wir eine <a href=\"/leistungen/it-betreuung-groessere-betriebe/\">eigene Seite für größere Betriebe</a>. Die Grenze ist nicht scharf: Ein 25-Arbeitsplatz-Betrieb mit einer einzigen Anwendung liegt oft näher an dieser Seite als ein 15er mit drei Standorten."},
            {"q": "Was kostet die IT-Betreuung für einen typischen Kleinbetrieb konkret?",
             "a": "Rechenbeispiel für einen Betrieb mit fünf Arbeitsplätzen, einem Server und einer Datensicherung: 5 × 29 € + 89 € + 49 € = 283 € im Monat, netto zzgl. USt. Bei zehn Arbeitsplätzen mit Server und Sicherung sind es 428 € im Monat (10 × 29 € + 89 € + 49 €). Kommen Ihre Mitarbeiter mit Microsoft 365, kommt der Lizenzpreis von Microsoft dazu — den zahlen Sie direkt an Microsoft, wir richten nur ein."},
            {"q": "Wir haben nur zwei bis drei Rechner — braucht das schon Betreuung?",
    ...
    "ki-automatisierung": {
        ...
        "intro": "Automatisierung lohnt sich nicht dort, wo sie beeindruckend aussieht, sondern dort, wo dieselbe Handbewegung jeden Tag zwanzigmal passiert: dieselbe Frage beantworten, denselben Termin eintragen, dieselbe Bestätigung schreiben. Deshalb fangen wir nie mit der Technik an, sondern mit der Frage, welche fünf Minuten sich am häufigsten wiederholen. Alles andere ist Spielerei mit Rechnung. KI-Automatisierung ist dabei kein eigenes Produkt, sondern ein Ablauf: Ein Programm nimmt eine wiederkehrende Aufgabe entgegen — eine immer gleiche Frage, eine Terminanfrage, eine Bestätigung —, beantwortet oder überträgt sie und legt das Ergebnis in dem System ab, in dem ohnehin gearbeitet wird. Was nur selten vorkommt oder jedes Mal neu entschieden werden muss, bleibt bewusst bei einem Menschen.",
    ...
    "it-betreuung-groessere-betriebe": {
        ...
        "probleme": [
            "Die Dokumentation lebt in vier Köpfen und in keinem Dokument.",
            "Es gibt kein aktuelles Bild von allem, was läuft — Server, Anwendungen, Zugänge, Verträge.",
            "Standorte wurden nach und nach angebunden, jeder anders.",
            "Bei einer Abwesenheit steht nichts still, aber niemand traut sich an eine Änderung.",
            "Eine interne IT-Stelle ist da, hat aber weder Zeit noch Vertretung.",
        ],
        "leistung_h": "Was wir für größere Betriebe übernehmen",
        "leistungen": [
            "Bestandsaufnahme und Dokumentation aller Server, Arbeitsplätze, Anwendungen, Zugänge und Verträge",
            "Fester Ansprechpartner mit Vertretung; ein zweiter Techniker kennt Ihr Netz",
            ...
            "Co-Betreuung neben einer vorhandenen internen IT: Zweitmeinung, Vertretung, Ausnahmefälle, Themen ohne Zeit",
            "Regelmäßige Betriebssitzung (Quartal), schriftlich: was lief, was fiel auf, was steht an",
        ],
        "ablauf_h": "Wie wir größere Betriebe übernehmen",
        "ablauf": [
            {"h": "Bestandsaufnahme mit Begehung", "t": "Wir gehen die Standorte ab und lesen die Server, das Netz und die Anwendungen aus. Am Ende steht eine geschriebene Übersicht dessen, was Sie haben, und eine Liste der Stellen, an denen wir zuerst nachfassen würden."},
            {"h": "Übernahme in Abschnitten", "t": "Übernommen wird nicht auf einen Schlag, sondern nach Priorität: erst die Sicherung, dann Server und Zugänge, dann die Arbeitsplätze. Ihre laufende Arbeit merkt davon nichts."},
            {"h": "Laufender Betrieb mit Dokumentation", "t": "Ab da meldet sich der Ansprechpartner, wenn etwas auffällt, statt Sie sich melden zu lassen. Jede Änderung wird eingetragen. Einmal im Quartal sprechen wir darüber, was ansteht."},
        ],
        "preis_h": "Was das kostet",
        ...
        "faq": [
            ...
            {"q": "Wir haben mehrere Standorte — geht das per Fernwartung?",
             "a": "Für den Betrieb ja: Der gesicherte Zugriff kennt keinen Unterschied zwischen einem und fünf Standorten. Für Aufbau, Verkabelung und Hardware kommen wir vor Ort im Einzugsgebiet um Lenzing (rund eine Fahrstunde); für weiter entfernte Standorte sprechen wir vorher darüber, ob wir selbst anreisen oder mit einem Handwerker vor Ort zusammenarbeiten — die Anfahrt steht immer vorher schriftlich im Angebot."},
            {"q": "Was, wenn wir eine bestimmte Verfügbarkeit brauchen?",
             "a": "Reaktionszeiten außerhalb der Bürozeiten und feste Wiederherstellungszeiten sind Gegenstand einer eigenen Vereinbarung, weil sie den Aufwand erhöhen und die Kosten. Wir sagen Ihnen ehrlich, welche Zusage sich mit welchem Aufwand halten lässt, statt eine 24/7-Zusage in einen Betreuungsvertrag zu schreiben, die im Ernstfall an einem einzelnen Menschen hängt."},
            {"q": "Wie steigen wir wieder aus, wenn es doch nicht passt?",
