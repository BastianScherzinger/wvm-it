...
BEGRIFFE = {
    ...
    "fernwartung": {
        ...
        "abschnitte": [
            ...
            {"h": "Fernwartung ohne Vertrag",
             "t": "Fernwartung ist nicht an eine laufende Betreuung gebunden. Wer ein einzelnes Problem hat — der Drucker druckt nicht, Outlook fragt nach dem Kennwort, der Rechner ist langsam —, bekommt dieselbe Sitzung auch einmalig: Sie geben den Zugriff frei, sehen jeden Schritt mit und bezahlen die tatsächliche Zeit. Wie das abläuft und was es kostet, steht auf der Seite <a href='/it-hilfe/'>IT-Hilfe ohne Vertrag</a>."},
        ],
    ...
    "managed-services": {
        ...
        "abschnitte": [
            ...
            {"h": "Woran Sie merken, dass sich Managed Services für Sie lohnen",
             "t": "Ein gutes Zeichen ist die eigene Rechnung: Wer im Jahr mehrere Stunden Einzelhilfe zahlt, immer wieder für dieselben Dinge — Updates, ein volles Postfach, ein Rechner, der nicht mehr startet —, fährt mit einem festen Monatsbetrag meist günstiger und hat weniger Ausfall. Wer dagegen zwei, drei Mal im Jahr jemanden braucht, bleibt besser bei der <a href='/it-hilfe/'>IT-Hilfe ohne Vertrag</a>. Den Vergleich mit Rechenweg gibt es unter <a href='/vergleich/it-betreuung-vs-stundenabrechnung/'>Betreuung oder Stundenabrechnung</a>."},
        ],
    ...
    "raid": {
        ...
        "abschnitte": [
            ...
            {"h": "Woran Sie merken, dass Ihr RAID Sie im Stich lassen kann",
             "t": "Drei Zeichen genügen: Niemand im Betrieb weiß, ob eine Platte im Verbund schon ausgefallen ist; die Platten sind alle gleich alt und älter als fünf Jahre; und es gibt keine Sicherung außerhalb des Geräts. Trifft eines davon zu, ist der nächste Schritt keine neue Hardware, sondern ein Blick auf den Zustand der Platten und auf die Sicherung — das geht per Fernwartung. Laufend überwacht wird es in der <a href='/leistungen/server-datensicherung/'>Server-Betreuung</a>."},
        ],
    ...
    "terminalserver": {
        ...
        "abschnitte": [
            ...
            {"h": "Woran Sie merken, dass ein Terminalserver passt",
             "t": "Wenn eine Fachanwendung — Kanzleisoftware, Praxisverwaltung, Warenwirtschaft — auf jedem Rechner einzeln installiert und aktualisiert werden muss, wenn Leute von zu Hause auf genau diese Anwendung zugreifen sollen, oder wenn langsame Leitungen die Anwendung im Homeoffice unbrauchbar machen. Ob ein eigener Server dafür nötig ist, klärt die Einrichtungsseite <a href='/einrichten/server/'>Server einrichten</a> mit der Vorfrage, ob es überhaupt einer sein muss."},
        ],
    ...
    "netzwerksegmentierung": {
        ...
        "abschnitte": [
            ...
            {"h": "Woran Sie merken, dass Ihr Netz getrennt gehört",
             "t": "Wenn Gäste über dasselbe WLAN surfen wie die Buchhaltung, wenn Kasse, Kameras oder Maschinen im selben Netz hängen wie die Büro-PCs, oder wenn niemand sagen kann, welches Gerät welches erreichen muss. Jedes davon heißt: Ein einziges befallenes Gerät erreicht alles. Der erste Schritt ist eine Liste der Geräte und ihrer Verbindungen; die Trennung selbst richten wir zusammen mit <a href='/einrichten/firewall-vpn/'>Firewall und VPN</a> ein."},
        ],
    ...
    "sla": {
        ...
        "abschnitte": [
            ...
            {"h": "Woran Sie ein SLA erkennen, das Ihnen nützt",
             "t": "Ein SLA hilft Ihnen, wenn es drei Dinge beantwortet: wen Sie im Ernstfall anrufen, was in welcher Reihenfolge wiederhergestellt wird, und wo die Zugänge dokumentiert sind. Steht dort nur eine Reaktionszeit in Stunden, ist es ein Versprechen ohne Ablauf. Was bei uns vereinbart wird und was nicht, steht bei der <a href='/leistungen/edv-it-betreuung/'>laufenden EDV-Betreuung</a>; wer keine Betreuung braucht, bekommt einzelne Hilfe ohne Vertrag."},
        ],
