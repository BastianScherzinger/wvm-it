...
REGIONEN = {
    ...
    "voecklabruck": {
        ...
        "desc": "IT-Dienstleister im Bezirk Vöcklabruck: EDV-Betreuung, Netzwerk, IT-Sicherheit. Sitz in Lenzing, 6 km — vor Ort in rund 10 Minuten. Termin vereinbaren.",
    ...
    "attersee": {
        ...
        "desc": "IT und Technik rund um den Attersee: WLAN für Hotels und Ferienwohnungen, Netzwerk, Smarthome. Sitz in Lenzing, 8 km entfernt. Angebot anfordern.",
    ...
    "gmunden": {
        ...
        "desc": "IT-Dienstleister für Betriebe in Gmunden und am Traunsee: EDV-Betreuung, Netzwerk, IT-Sicherheit. 22 km von unserem Sitz in Lenzing. Termin vereinbaren.",
    ...
    "bad-ischl": {
        ...
        "desc": "IT-Betreuung, Konferenz- und Veranstaltungstechnik für Bad Ischl und das Salzkammergut. 38 km von unserem Sitz in Lenzing. Angebot anfordern.",
    ...
    "wels": {
        ...
        "desc": "IT-Dienstleister für Betriebe in Wels: EDV-Betreuung, Netzwerk, Server, IT-Sicherheit. 40 km von Lenzing, überwiegend per Fernwartung. Angebot anfordern.",
    ...
    "salzburg": {
        ...
        "desc": "IT-Dienstleister für Betriebe in Salzburg: EDV-Betreuung, IT-Sicherheit, Netzwerk. 55 km von Lenzing, laufender Betrieb per Fernwartung. Angebot anfordern.",
    ...
    "linz": {
        ...
        "desc": "IT-Dienstleister für Betriebe in Linz: laufende EDV-Betreuung, Server, Netzwerk, IT-Sicherheit — per Fernwartung, vor Ort nach Termin. Angebot anfordern.",
