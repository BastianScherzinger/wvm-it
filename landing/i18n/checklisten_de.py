...
CHECKLISTEN = {
    ...
    "it-dienstleister-wechseln": {
        ...
        "meta_titel": "Checkliste: Wechsel des IT-Dienstleisters | WVM-IT",
        "desc": "Was Sie herausverlangen müssen, bevor Sie kündigen: Zugänge, Domain, Lizenzen, Dokumentation. Zum Abhaken und Ausdrucken. Liste durchgehen.",
    ...
    "neuer-arbeitsplatz": {
        ...
        "meta_titel": "Checkliste für einen neuen IT-Arbeitsplatz | WVM-IT",
        "desc": "Vom Gerät bis zum Konto: was ein einsatzbereiter Arbeitsplatz braucht — und was am ersten Arbeitstag fertig sein muss. Liste abhaken.",
    ...
    "it-jahrescheck": {
        ...
        "desc": "Einmal im Jahr durchgehen: Sicherung, Zugänge, Verträge, Geräte, Lizenzen. Die Liste, die den Großteil aller IT-Überraschungen verhindert. Liste durchgehen.",
