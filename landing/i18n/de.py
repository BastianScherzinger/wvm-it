...
PACK = {
    ...
    "kontakt_seite": {
        ...
        "intro": "Am schnellsten geht es per WhatsApp oder Telefon – ein Satz genügt, worum es geht, und bei einer laufenden Störung sparen zwei Minuten am Telefon mehr Zeit als jede Beschreibung per E-Mail. Können Sie gerade nicht sprechen, nutzen Sie den Rückruf: Sie hinterlassen Ihre Nummer und ein Stichwort, wir melden uns innerhalb der Erreichbarkeit unten zurück. Wer lieber schreibt, nutzt das Formular; es fragt nur nach dem, was wir wirklich brauchen. Je genauer die Anfrage, desto konkreter fällt die erste Antwort aus: Nennen Sie kurz, worum es geht – ein akuter Ausfall, eine laufende Betreuung, eine neue Webseite oder ein Projekt vor Ort –, wie viele Arbeitsplätze oder Server betroffen sind und ob es eilt. Mit diesen Angaben steht in unserer ersten Antwort bereits eine Einschätzung und keine weitere Rückfrage-Schleife.",
        "wege_h": "Vier Wege, uns zu erreichen",
        "zeiten_h": "Erreichbarkeit",
        "zeiten_t": "Montag bis Freitag, 9 bis 18 Uhr. Anfragen außerhalb dieser Zeiten beantworten wir am nächsten Werktag – innerhalb von 24 Stunden, nicht innerhalb einer Woche. Die meiste Arbeit erledigen wir per Fernwartung, ohne dass jemand zu Ihnen fahren muss – das ist schneller und es fällt keine Anfahrt an. Ist ein Termin vor Ort nötig, vereinbaren wir vorher Zeitfenster und Aufwand, damit Sie wissen, womit Sie rechnen. Nach einer Anfrage sehen wir uns zunächst an, worum es geht, und melden uns mit einer ersten Einschätzung; ein schriftliches Angebot folgt erst danach und ist bis zur Annahme unverbindlich.",
        "daten_h": "Firmendaten",
