...
PACK = {
    ...
    "hub": {
        ...
        "intro": "Elf Leistungen, drei Bereiche &ndash; und ein Ansprechpartner für alle. Was Sie hier finden, ist bewusst keine Liste von Schlagworten: Zu jeder Leistung gibt es eine eigene Seite mit dem, was enthalten ist, wie es abläuft und was es kostet. Wenn Sie nicht sicher sind, wo Sie anfangen sollen: EDV und IT passt, wenn eine laufende Technik betreut werden soll &ndash; Arbeitsplätze, Server, Datensicherung, Sicherheit. Sichtbarkeit und Web passt, wenn Kundschaft Sie online finden oder ein Auftritt entstehen soll. Technik vor Ort passt, sobald etwas verkabelt, aufgebaut oder eingemessen werden muss. Eine Zusammenarbeit beginnt in den meisten Fällen gleich: mit einer kurzen Bestandsaufnahme dessen, was heute schon da ist, und einer Einschätzung, was sich davon per Fernwartung erledigen lässt und was einen Termin vor Ort braucht. Arbeitsplätze, Server, E-Mail, Updates und die Datensicherung laufen fast immer aus der Ferne; Verkabelung, Hardware-Einbau und Vor-Ort-Technik nicht.",
        "it_h": "EDV und IT",
        "it_t": "Der Kern: die laufende Technik Ihres Betriebs, überwiegend aus der Ferne betreut. Dazu zählen Arbeitsplätze, Server, Netzwerk, Datensicherung und die IT-Sicherheit &ndash; alles, was im Alltag laufen muss, ohne dass jemand ständig danebensteht. Der überwiegende Teil davon lässt sich per Fernwartung erledigen; nur der erste Netzwerkaufbau oder ein Hardware-Tausch braucht einen Termin vor Ort.",
    ...
    "referenzen_seite": {
        ...
        "intro": "Diese Seite ist kurz, und das hat einen Grund: Wir führen hier nur auf, was wir belegen können. Eine Wand aus fremden Firmenlogos wäre in einer Minute gebaut &ndash; nur eben ohne die Zustimmung der Kunden, und genau die fehlt uns in den meisten Fällen. Erfundene Kundenstimmen und ausgedachte Zahlen finden Sie bei uns nicht, auch nicht in kleiner Schrift, und ebenso wenig Bewertungen oder Zertifikate, die sich nicht mit einer echten Quelle belegen lassen.",
        "mehr_h": "Warum hier nicht mehr steht",
        "mehr_t": "Ein Teil unserer Arbeit sind Betriebe, deren EDV wir laufend betreuen. Wer seine IT in fremde Hände gibt, will das selten öffentlich sehen, und Stillschweigen ist in diesem Geschäft eher die Regel als die Ausnahme. Wir fragen deshalb jeden Kunden einzeln und nennen niemanden ohne Zustimmung; auf Wunsch stellen wir im Gespräch gerne einen Kontakt her. Was Sie stattdessen prüfen können, steht bereits offen auf dieser Website: Die Preise stehen auf jeder Leistungsseite und in der vollständigen Preisliste, nicht erst nach einem Gespräch. Im Kostenrechner sehen Sie die Monats- und Jahressumme für Ihren eigenen Betrieb, gerechnet mit denselben Sätzen wie in jedem Angebot. Der IT-Sicherheits-Selbsttest zeigt in zehn Fragen, wo Ihre IT heute steht, ohne E-Mail-Abfrage und ohne Speicherung. Und das erste Gespräch selbst kostet nichts &ndash; darin sagen wir auch, wenn sich für Sie weniger lohnt, als ursprünglich angefragt.",
