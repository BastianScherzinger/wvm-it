...
PACK = {
    ...
    "vergleiche_seite": {
        ...
        "auswahl_t": "Es sind die drei Entscheidungen, die in Erstgesprächen am häufigsten offen sind. Sie haben eines gemeinsam: Man kann sie nicht sinnvoll treffen, ohne den eigenen Betrieb anzusehen — deshalb steht auf jeder Seite die Frage, an der es hängt, und nicht eine Empfehlung. Die erste ist eine reine Rechenfrage: Ab wie vielen Supportstunden im Monat ist die laufende Betreuung günstiger als die Abrechnung nach Aufwand? Diese Schwelle steht auf der Seite, und der Rechenweg daneben. Die zweite hängt an dem, was schon dasteht — ein Server, der noch Jahre vor sich hat, wird nicht ersetzt, weil Cloud moderner klingt. Die dritte ist selten eine Technikfrage: Beide Pakete können, was ein Betrieb im Alltag braucht; den Ausschlag geben Gewohnheit, die vorhandene Fachsoftware und die Frage, wer die Postfächer verwaltet. Fehlt Ihnen ein Vergleich, schreiben Sie uns; wir ergänzen ihn, wenn die Frage öfter kommt.",
        ...
        "intro": "Jede dieser Seiten nennt ausdrücklich, wann die andere Variante die richtige ist. Ein Vergleich, der immer zum eigenen Angebot führt, ist keiner — er ist Werbung mit Tabelle. Drei Gegenüberstellungen stehen hier, und alle drei sind gleich gebaut: zuerst die Frage, an der die Entscheidung hängt, dann eine Tabelle mit den Kriterien nebeneinander, dann zwei gleich große Listen dafür, wann die eine und wann die andere Seite gewinnt, dann die Rechnung mit Ihren eigenen Zahlen, zuletzt die Fragen, die dazu regelmäßig kommen. Wer wenig Zeit hat, liest den ersten Absatz und die Tabelle; wer die Entscheidung wirklich treffen muss, braucht die Rechnung darunter.",
    ...
    "hub": {
        ...
        "intro": "Elf Leistungen, drei Bereiche &ndash; und ein Ansprechpartner für alle. Was Sie hier finden, ist bewusst keine Liste von Schlagworten: Zu jeder Leistung gibt es eine eigene Seite mit dem, was enthalten ist, wie es abläuft und was es kostet. Die Reihenfolge der drei Blöcke ist keine Rangfolge, sondern eine Antwort auf die Frage, die zuerst kommt: Was muss täglich laufen (vier Leistungen unter EDV und IT), was bringt neue Anfragen (fünf unter Sichtbarkeit und Web), was muss gebaut werden (zwei unter Technik vor Ort). Wer nicht weiß, wo er anfangen soll, geht nach dem Preisschild an jeder Kachel: Was mit einem Monatsbetrag beginnt, ist laufende Betreuung; was mit einem einmaligen Betrag beginnt, ist ein Projekt mit Anfang und Ende; was &bdquo;auf Anfrage&ldquo; trägt, hängt so stark an Raum, Bestand und Umfang, dass ein Startpreis nichts aussagen würde. Fragen zu einer einzelnen Leistung beantworten wir an Werktagen innerhalb von 24 Stunden &ndash; auch dann, wenn daraus kein Auftrag wird.",
        "it_h": "EDV und IT",
        "it_t": "Der Kern: die laufende Technik Ihres Betriebs, überwiegend aus der Ferne betreut. Vier Leistungen gehören dazu &ndash; die Arbeitsplätze, Server und Datensicherung, Netzwerk und WLAN, und die IT-Sicherheit. Also alles, was morgens funktionieren muss, damit gearbeitet werden kann. Abgerechnet wird je Arbeitsplatz und Monat, ohne Mindestlaufzeit über ein Quartal hinaus.",
        "sicht_h": "Sichtbarkeit und Web",
        "sicht_t": "Damit Sie auch gefunden werden von Menschen, die Sie noch nicht kennen. Fünf Leistungen greifen hier ineinander: Webseite, Suchmaschinenoptimierung, Google Ads, Hosting und Wartung, KI-Automatisierung. Eine Seite ohne Sichtbarkeit bringt keine Anfragen, und Werbung auf eine langsame Seite ist bezahlter Verlust &ndash; deshalb steht auf jeder dieser Seiten, was zuerst dran ist und was warten kann.",
        "vorort_h": "Technik vor Ort",
        "vorort_t": "Was verkabelt, aufgebaut und eingemessen werden muss &ndash; projektbezogen. Zwei Leistungen stehen hier: Gebäude- und Smarthome-Automation mit KNX und Loxone, und Konferenz- und Veranstaltungstechnik. Bei beiden hängt der Preis so stark am Bestand, dass er erst nach einer Bestandsaufnahme feststeht &ndash; schriftlich, und vor dem ersten Handgriff.",
    },
    "kosten_seite": {
    ...
    "kontakt_seite": {
        ...
        "kurz": "WVM-IT ist per WhatsApp, Telefon und E-Mail erreichbar; auf Wunsch rufen wir zurück. Anfragen beantworten wir an Werktagen innerhalb von 24 Stunden, telefonisch erreichbar sind wir Montag bis Freitag von 9 bis 18 Uhr. Der Sitz ist die Waldstraße 19/1 in 4860 Lenzing in Oberösterreich. Betreut werden Betriebe in ganz Österreich und Deutschland, überwiegend per Fernwartung; für Einsätze vor Ort reicht das Einzugsgebiet von Vöcklabruck und der Attersee-Region über Gmunden und Bad Ischl bis nach Wels, Linz und Salzburg.",
        "intro": "Am schnellsten geht es per WhatsApp oder Telefon &ndash; ein Satz genügt, worum es geht. Wenn Sie lieber schreiben, nutzen Sie das Formular; es fragt nur nach dem, was wir wirklich brauchen. Für eine belastbare erste Einschätzung hilft uns dreierlei: wie viele Arbeitsplätze und Server im Betrieb stehen, worum es konkret geht, und bis wann es gebraucht wird.",
        "wege_h": "Vier Wege, uns zu erreichen",
        "zeiten_h": "Erreichbarkeit",
        "zeiten_t": "Montag bis Freitag, 9 bis 18 Uhr. Anfragen außerhalb dieser Zeiten beantworten wir am nächsten Werktag &ndash; innerhalb von 24 Stunden, nicht innerhalb einer Woche. Was danach passiert, ist immer derselbe Ablauf: Wir lesen die Anfrage, stellen die Rückfragen, die wirklich nötig sind, und nennen dann entweder einen Termin oder gleich eine Zahl. Wer bereits in laufender Betreuung ist, geht denselben Weg ohne Formular &ndash; ein Anruf oder eine E-Mail genügt, und das Gerät muss dafür nicht beschrieben werden, weil es dokumentiert ist. Steht dagegen ein Betrieb still, drehen Sie die Reihenfolge um: erst anrufen, dann schreiben. Für diesen Fall gibt es eine eigene Notfallseite mit den Schritten, die vor unserem Rückruf sinnvoll sind.",
        "daten_h": "Firmendaten",
        "inhaber": "Inhaber",
        "tel": "Telefon",
        "mail": "E-Mail",
        "gebiet": "Einsatzgebiet",
        "gebiet_t": "Österreich und Deutschland, überwiegend per Fernwartung; vor Ort im Raum Vöcklabruck, Attersee, Gmunden, Bad Ischl, Wels, Linz und Salzburg",
    },
