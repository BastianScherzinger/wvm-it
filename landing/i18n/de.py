...
PACK = {
    ...
    "hero": {
        ...
        "subline": "Webdesign mit messbaren Ergebnissen, dazu Smarthome, Konferenz- und Veranstaltungstechnik, EDV und KI. Alles aus einer Hand, in Österreich und Deutschland.",
    ...
    "faq": {
        ...
        "items": [
            {"q": "Was kostet eine professionelle Website bei WVM-IT?",
             "a": "Ein One-Pager startet ab 350 €, eine mehrseitige Business-Website ab 1.490 €, eine Premium-Seite mit Animationen ab 2.900 €. Alle Angaben sind unverbindliche Richtpreise (netto zzgl. USt.); den Endpreis stimmen wir im Gespräch ab. Ihr persönliches Angebot sehen Sie in unter einer Minute im Online-Konfigurator."},
            {"q": "In welchen Regionen arbeitet WVM-IT?",
             "a": "WVM-IT betreut Kunden in ganz Österreich und Deutschland. Webseiten, Hosting, SEO und KI-Automatisierung setzen wir remote im gesamten DACH-Raum um; Technik-Installationen wie Smarthome, Konferenz- und Veranstaltungstechnik oder EDV erfolgen projektbezogen vor Ort, unter anderem in Wien, Graz, Linz, Salzburg, München und Stuttgart."},
            {"q": "Was bedeutet „alles aus einer Hand“ bei WVM-IT?",
             "a": "Sie haben einen festen Ansprechpartner für Technik und Digitales: Gebäude- und Smarthome-Automation, Konferenz- und Veranstaltungstechnik, EDV, Netzwerk und Sicherheit sowie Webseiten, Hosting, SEO und KI. Statt mehrere Firmen zu koordinieren, kommt alles gebündelt von WVM-IT und ausgewählten Partnern."},
            {"q": "Was sind Loxone und KNX?",
             "a": "Loxone und KNX sind etablierte Standards für Gebäude- und Smarthome-Automation. Damit lassen sich Licht, Heizung, Beschattung, Sicherheit und Medientechnik zentral steuern und intelligent vernetzen. WVM-IT plant, programmiert und betreut solche Systeme für Privathäuser und Unternehmen."},
            {"q": "Wie schnell bekomme ich eine Antwort und mein Angebot?",
    ...
    "trust": {
        ...
        "t2": "Testseite gratis, ohne Bedingung",
    ...
    "technik": {
        "eyebrow": "Für Firmen",
        "h": "Technik vor Ort",
        "sub": "Projektbezogen geplant, installiert und betreut, in Österreich und Deutschland. Ein Ansprechpartner für alles.",
