...
VERGLEICHE = {
    ...
    "server-vs-cloud": {
        "nav": "Server or cloud",
        "titel": "Server or cloud: the decision in 3 criteria | WVM-IT",
        "desc": "Server on site or cloud: what the decision depends on — software, data volumes, connection, downtime. Request free advice now.",
