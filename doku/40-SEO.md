...
status: teilweise
fortschritt: 90
zusammenfassung: Am 18.09.2026 (Paket 253, Zweig sofort/2026-09-18-pr01-und-2-weitere, noch nicht auf main, Tests laut Bausitzung nicht gelaufen) GE41 eingebaut -- der Preiskatalog (OfferCatalog am #business-Knoten) steht im Schema nur noch auf der Startseite, /kosten/ und /angebot/, den drei Seiten, die ihn sichtbar zeigen; vorher trug ihn jeder Graph, auch dort, wo kein Preis zu sehen ist. Die Service- und Offer-Knoten der Leistungsseiten bleiben. test_preiskatalog_nur_wo_er_sichtbar_ist haelt das fest. Davor am 12.09.2026 GE25 abgearbeitet, und zwar anders als gemeldet: Der Katalog fuehrte 19 von 198 Seiten ohne konkrete Zahl und nannte darunter /en/kosten/, das mit costs from EUR 29 per workstation and month beginnt -- im Englischen steht das Waehrungszeichen vor der Zahl, und eine Regel, die Zahl-dann-Einheit sucht, sieht sie nicht. Nachgemessen mit einer Regel ohne Einheitenliste bleibt genau eine Seite uebrig, und das ist der Hub der Vergleichsseiten: ausgerechnet die Seite, auf der jede Unterseite eine Geldfrage beantwortet, kam in allen drei Sprachen ohne eine einzige Zahl aus (Deutsch und Rumaenisch rutschten nur an Microsoft 365 oder durch, einem Produktnamen). Sein Antwortabsatz nennt jetzt dreisprachig die Saetze, mit denen dort gerechnet wird -- 29 Euro je Arbeitsplatz und Monat, 95 Euro je Stunde ohne Vertrag, bei Anschaffungen die Gesamtkosten ueber drei Jahre statt des Kaufpreises -- alle aus ANGEBOT_GROUPS, keine neue Zahl. Der zweite Fund zaehlt mehr: Der Beitrags-Hub versprach 15 Fachbeitraege, es sind 18; der Satz steht in der Vorlage, die Eintraege in landing/beitraege.py, und eine falsche Zahl sieht fuer eine Antwortmaschine zitierfaehig aus. ZahlenStimmenTest haelt beide nur-deutschen Hubs jetzt gegen die Laenge ihrer Strukturliste, und eine weitere Pruefung verlangt auf jeder der 198 Adressen mindestens eine Zahl mit Bezug. Offen bleibt, dass derselbe Hub in Titel, Beschreibung und Ueberschrift weiter von drei Vergleichen spricht -- seit dem 08.09.2026 sind es vier; eine halbe Korrektur waere schlechter als keine. Davor am 11.09.2026 IS06 (Titel nennt Ort oder Nutzen) als begruendete Ausnahme eingetragen, ohne eine Zeile Code: Die Regel kennt als Ort nur Lenzing und als Nutzen eine feste Wortliste; die Regionsseiten nennen ihre eigene Stadt, Fachbeitraege und Glossar ihren Nutzen in eigenen Worten, Einrichtungsseiten ohne Festpreis und die Rechtstexte lassen Zahl und Versprechen aus Gruenden der Projektregeln weg. Am 10.09.2026 zum ersten Mal seit dem Ausbau aus der Search Console gemessen -- 90 Tage, 410 Impressionen, 16 Klicks, Position 53,3 -- und drei Befunde daraus behoben: das Crawl-Leck von 28 Adressen unter Sprachpraefix (301 statt 404), die Kannibalisierung von it betreuung kosten ueber drei eigene Seiten, und die fehlende Zuordnung der Marke wvm. Dazu Oberoesterreich in Ueberschrift und Antwortabsatz des Regions-Wegweisers, weil it betreuung oberoesterreich auf Position 45 steht und der Ort bis dahin nur im Title stand. Was in Reichweite ist, sind die Ortsseiten (Gmunden 9,0, Salzburg 18,1), nicht die Ratgeberthemen. Davor am selben Tag: vier Seiten mit einem Definitionssatz bekommen, je dreisprachig und je im vorhandenen Absatz (GE26): /kontakt/ sagt jetzt, was Fernwartung ist, /einrichten/ was ein Festpreis ist -- samt der Begruendung, warum der Preis dort ohne ab steht --, /leistungen/server-datensicherung/ was eine Sicherung zur Sicherung macht, /leistungen/ki-automatisierung/ dass Automatisierung ein Ablauf ist und kein Produkt. Die einzige Zahl darin, 120 Euro je Stunde vor Ort, stammt aus ANGEBOT_GROUPS; die vier Rechtstexte bleiben bewusst ohne. Davor am 06.09. nachgemessen statt fortgeschrieben: Titel mit Ort oder Zahl 70 Prozent (Doku sagte 17), Beschreibungen mit Handlungsaufforderung 92 Prozent (sagte 2), nichtssagende Ankertexte null (sagte 948), doppelte Titel null (sagte 6). Der verbliebene kritische Punkt war der Umfang; 16 Beitraege haben jetzt Folgefragen mit FAQPage-Schema, der Regionen-Hub eigenen Text.
offen: 7
...
| Baustein | Stand |
|---|---|
| Antwort-zuerst-Absatz `templates/antwort.html` auf allen Seitentypen (G1, S1), `speakable` | erledigt 29.08.2026 — **Messung sieht nur 14 von 158 Seiten mit zitierfähiger Antwort** (`GE23`, Gewicht 9, schwerste GEO-Regel): Startseite, Kontakt, Angebot „weder Definition noch Zahl"; 72 von 152 Seiten nennen Zahlen (`GE25`), 70 Definitionssätze (`GE26`), 14 mit Frage-Überschrift (`GE24`). **Von den drei namentlich genannten Seiten trägt `/kontakt/` seit dem 10.09.2026 eine Definition** (Zeile darunter); `/` und `/angebot/` bleiben offen. **`GE25` ist am 12.09.2026 abgearbeitet** (Zeile darunter): Von 19 gemeldeten Seiten ohne Zahl blieb nachgemessen **eine** übrig |
| **Zahlen im Fliesstext: eine Seite von 198 hatte keine** (12.09.2026, `GE25`) | Der Katalog meldet laut Commit **19 von 198 Seiten ohne konkrete Zahl** und nennt darunter `/en/kontakt/` und `/en/kosten/`. **Nachgemessen hält das nicht:** `/en/kosten/` beginnt mit „costs from €29 per workstation and month". Was dort auffällt, ist die **Schreibweise** — im Englischen steht das Währungszeichen **vor** der Zahl, und eine Regel, die „Zahl, dann Einheit" sucht, sieht sie deshalb nicht. Mit einer Regel ohne Einheitenliste (Ziffer, dann ein Wort oder ein Währungs- bzw. Prozentzeichen; nur im `<main>`, nur in Absätzen und Listenpunkten — so gilt sie in allen drei Sprachen gleich) bleibt von neunzehn Seiten **eine** übrig: der **Hub der Vergleichsseiten**, ausgerechnet die Seite, auf der jede Unterseite eine Geldfrage beantwortet. Er kam in **allen drei Sprachen** ohne eine einzige Zahl aus; Deutsch und Rumänisch rutschten nur an „Microsoft 365 oder" durch, also an einem Produktnamen. Der Antwortabsatz nennt jetzt dreisprachig die Sätze, mit denen dort gerechnet wird: **29 € je Arbeitsplatz und Monat** für die laufende Betreuung, **95 € je Stunde** ohne Vertrag, und bei Anschaffungen die **Gesamtkosten über drei Jahre** statt des Kaufpreises. Beide Preise stehen so in `ANGEBOT_GROUPS` (`it_betreuung` `mtl` 29, `it_support` `std` 95) — **keine neue Zahl.** Gesichert von `landing/tests/test_zahlen.py`: Eine Prüfung geht über **alle** Adressen und verlangt je Seite mindestens eine Zahl mit Bezug; eine Antwortmaschine zitiert, was sich belegen lässt, und ein Absatz ohne Zahl liefert ihr weder Preis noch Frist noch Menge. **Offen bleibt, dass derselbe Hub in Titel, Beschreibung und Überschrift weiter von „drei" Vergleichen spricht** — seit dem 08.09.2026 sind es vier ([80-AUFGABEN.md](80-AUFGABEN.md), „Offen" Nr. 14) | Commit `37f9db2`; `pruefe_seite` laut Commit grün (198 URLs, 27 Preiszahlen), Suite 303 |
| **Preise im Schema nur, wo sie auf der Seite stehen** (18.09.2026, `GE41`) | Der `OfferCatalog` mit allen Positionen aus `ANGEBOT_GROUPS` hing am `#business`-Knoten und kam so über `_seiten_schema` in **jeden** Graphen — sichtbar ist der ganze Katalog aber nur auf der Startseite, `/kosten/` und `/angebot/`. Ein Preis im Schema, den der Besucher nicht sieht, ist dieselbe Behauptung wie eine FAQ, die nicht auf der Seite steht. Jetzt entscheidet ein Schalter: `_structured_data(mit_katalog=)` (Standard an, so ruft ihn die Startseite auf) und `_seiten_schema(katalog=)` (Standard aus, gesetzt nur in den Views `kosten` und `angebot`). Der Betrieb bleibt auf jeder Seite derselbe `#business`-Knoten, nur ohne Katalog; die `Service`- und `Offer`-Knoten der einzelnen Leistungsseiten sind nicht berührt, weil ihr Preis dort sichtbar steht. `test_preiskatalog_nur_wo_er_sichtbar_ist` verlangt den Katalog auf den drei Seiten und verbietet ihn auf `/kontakt/`, `/leistungen/` und `/referenzen/`. **Laut Bausitzung ist der Test noch nicht gelaufen** ([80-AUFGABEN.md](80-AUFGABEN.md), Offen Nr. 19) | Commit `619d733`, Zweig `sofort/2026-09-18-pr01-und-2-weitere` |
| **Eine Zahl im Text muss die Liste im Code zählen** (12.09.2026, `GE25`) | Beim Nachmessen fiel der zweite Fund auf, und er zählt mehr als eine fehlende Zahl: Der Beitrags-Hub `/aktuelles/` versprach im Antwortabsatz „**15 Fachbeiträge**" — es sind seit dem 08.09.2026 **18**. Der Satz steht in `templates/aktuelles.html`, die Einträge in `landing/beitraege.py`: zwei Stellen für dieselbe Aussage, und eine davon veraltet, ohne dass es jemandem auffällt. Für eine Antwortmaschine ist das schlimmer als eine fehlende Zahl, weil eine falsche zitierfähig aussieht. Korrigiert, und `ZahlenStimmenTest` hält die Zahl im Antwortabsatz **beider** nur-deutschen Hubs jetzt gegen die Länge ihrer Strukturliste (`/aktuelles/` 18, `/wissen/` 14 — letztere stimmte) | Commit `37f9db2` |
...
| 13 | **Der Vergleichs-Hub spricht in Titel, Beschreibung und Überschrift weiter von „drei" Vergleichen — es sind seit dem 08.09.2026 vier.** Betroffen sind `titel` („3 IT-Entscheidungen im Vergleich"), `desc` („die drei Gegenüberstellungen"), `auswahl_h` („Warum genau diese drei") mit `auswahl_t` und der Schlusssatz des Antwortabsatzes, je dreisprachig in `landing/i18n/{de,en,ro}.py` unter `vergleiche_seite`. Am 12.09.2026 bei `GE25` aufgefallen und **bewusst nicht halb korrigiert**: Überschriftentexte sind für dieses Werkzeug unantastbar, und eine Zahl an drei von vier Stellen zu ändern wäre schlechter als keine. Der Titel ist dabei der teuerste Teil — er trägt die Zahl in die Suchergebnisse | `GE25` ([80-AUFGABEN.md](80-AUFGABEN.md), „Offen" Nr. 14) | Bastian |
