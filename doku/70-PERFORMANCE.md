...
<!-- tempo:anfang -->
**Messung vom 17.09.2026** (Webagentur Scherzinger Overview, Regelstand 2026-09-16b). Bereich „Performance & Core Web Vitals“: **95,9 von 100**, Reifegrad „Referenz“.
...
| `/datenschutz/` | desktop | **100** | 0,34 s | 0,003 | 0 ms | 3 ms |
| `/impressum/` | mobile | **100** | 1,44 s | 0,000 | 0 ms | 2 ms |
| `/impressum/` | desktop | **96** | 0,32 s | 0,122 | 0 ms | 3 ms |
| `/kontakt/` | mobile | **100** | 1,20 s | 0,013 | 0 ms | 3 ms |
| `/kontakt/` | desktop | **89** | 0,29 s | 0,233 | 0 ms | 7 ms |
| `/kosten/rechner/` | mobile | **100** | 1,53 s | 0,010 | 0 ms | 3 ms |
| `/kosten/rechner/` | desktop | **96** | 0,45 s | 0,125 | 0 ms | 11 ms |
| `/leistungen/` | mobile | **100** | 1,35 s | 0,015 | 0 ms | 5 ms |
| `/leistungen/` | desktop | **92** | 0,42 s | 0,182 | 0 ms | 3 ms |
...
**Serverzeit (`server-response-time` aus PageSpeed): 9,5 ms** im Mittel. Das ist die Zahl, an der `PF09` und `PF10` hängen. Die Sekundenwerte, die der eigene Prüfstand je Seite notiert, sind Wanduhrzeiten bei sechs gleichzeitigen Abrufen samt Kaltstart — sie messen den Prüfstand, nicht den Server.
...
| `PF28` | Stile und Skripte werden verkleinert ausgeliefert | teilweise | nicht verkleinert: JS main.js?v=ab51164ab2c7 (15 kB) |

### Die grössten Bremsen laut Lighthouse

| Audit | Titel | Ersparnis |
|---|---|---:|
| `unused-css-rules` | Reduce unused CSS | 410 ms |
<!-- tempo:ende -->
