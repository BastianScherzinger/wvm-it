...
| **Inline-Skripte** | Jeder `<script>`-Block ohne `nonce="{{ request.csp_nonce }}"` wird vom Browser **nicht ausgeführt**. Die Content-Security-Policy wird durchgesetzt, nicht nur berichtet |
