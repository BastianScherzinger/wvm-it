...
| **Letzter Commit** | auf `main`: `8124d0d`, 11.09.2026 (Doku). **Gemergt und damit live** sind Paket 125, 147, 153 und 170 (`git branch --contains` nennt für `9b5993c`, `3b18af8`, `228f726` und `d87313f` am 12.09.2026 jeweils `main`), also auch `PJ11` mit `--constraint requirements.lock`. **Nicht** auf `main`: Paket 184 vom 12.09.2026 (`1675108`, `8bb52aa`, `c5d2094` auf `sofort/2026-09-12-vl21-und-2-weitere`) und weiterhin der Antwortabsatz der Rechtsseiten (`GE23`, `87f7dc3` auf `sofort/2026-09-08-ge23-und-2-weitere`) |
...
| Aufgaben | teilweise | 75 | Acht der dreizehn Punkte unter „Offen" sind erledigt, der Kontrast als letzter am 12.09.2026 — dabei kam ein neuer dazu: Die Barrierefreiheitserklärung räumt einen Rückstand ein, den es nicht mehr gibt. Offen bleiben CWV-Eintrag, Antwortzeit, die zwei Impressumsangaben von Florin, der Hardwaredefekt als Thema und dieser Rechtstext. | [80-AUFGABEN.md](80-AUFGABEN.md) |
